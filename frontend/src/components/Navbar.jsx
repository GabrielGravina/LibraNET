			...
			>
				...
				<ul className="flex items-center space-x-4">
					<li className="bg-black bg-opacity-50 px-4 py-2 rounded-lg border-2 border-white hover:opacity-80">
						<a href="#" className="text-amber-600 font-semibold text-3xl">Pesquisar Empréstimos</a>
					</li>
					<li className="bg-black bg-opacity-50 px-4 py-2 font-semibold text-3xl rounded-lg border-2 border-white hover:opacity-80">
						<Link
							to={`/livros/`}
					...
					<li className="bg-black bg-opacity-50 p-2 rounded-lg border-2 border-amber-600 hover:opacity-80">
						<a className="hover:opacity-80 hover:cursor-pointer p-2 rounded-lg flex items-center justify-center">
